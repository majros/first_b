export const messages = {
	'en-US': {
		...
		application: {
			headline: "Seaman's application form",
		...
		partners: {
			...
			'Klaus-Peter Offen under the name Reederei Claus-Peter Offen GmbH & Co. KG.',
		},
		samosCadets:{
			headline: 'SAMOS Cadets program of Ukrainian Nationality',
		...
		contact: {
			headline: 'We are always glad to see you in our office at:',
			title1: 'Crewing agency BARK on the map:',
		},
		cadets: {
			line1: 'The cadets page must be filled with content',
		},
		vacancies: {
			line1: 'Current vacancies for July 2018',
		},
	},
	'ru-RU': {
		drawerList: {
		...
		application: {
			headline: 'Анкета моряка',
			textItem1: 'Загрузите прилагаемую форму анкеты, заполните ее и отправьте на электронный адрес info@bark.com.ua',
		},
		company: {
		...
		partners: {
			...
			'1971 году Клаусом-Питером Оффеном под именем Reederei Claus-Peter Offen GmbH & Co. KG.',
		},
		samosCadets:{
			headline: 'SAMOS Кадетская программа для моряков с украинским гражданством',
			samosContent1: 'В дополнение к соответствующим обсуждениям и договоренностям в отношении предмета, пожалуйста, ' +
		...
		contact: {
			headline: 'Мы всегда рады видеть Вас в нашем офисе по адресу:',
			title1: 'Крюинговое агенство БАРК на карте Мариуполя:',
		},
		cadets: {
			line1: 'Cтраницу информации для кадетов необходимо наполнить контентом',
		},
		vacancies: {
			line1: 'Актуальные вакансии на июль 2018 года',
		},
	}
};